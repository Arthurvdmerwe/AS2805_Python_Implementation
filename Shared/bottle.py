    ...
    def wsgi(self, environ, start_response):
        ...
        try:
            ...
            if response.status_code in (100, 101, 204, 304) \
                ...
                out = []
            start_response(response.status_line, response.headerlist)
            return out
        except (KeyboardInterrupt, SystemExit, MemoryError):
            raise
        except:
...
class HeaderDict(MultiDict):
    ...
    def __init__(self, *a, **ka):
        super(HeaderDict, self).__init__(*a, **ka)
        self.dict = {}
...
class WSGIRefServer(ServerAdapter):
    def __init__(self, host='127.0.0.1', port=8080, **options):
        super(WSGIRefServer, self).__init__(host='127.0.0.1', port=8080, **options)
        self.port = port
        self.host = host
...
class MakoTemplate(BaseTemplate):
    def __init__(self, source=None, name=None, lookup=None, encoding='utf8', **settings):
        super(MakoTemplate, self).__init__(source=None, name=None, lookup=None, encoding='utf8', **settings)
        self.encoding = encoding
        self.name = name
        self.source = source
...
class CheetahTemplate(BaseTemplate):
    def __init__(self, source=None, name=None, lookup=None, encoding='utf8', **settings):
        super(CheetahTemplate, self).__init__(source=None, name=None, lookup=None, encoding='utf8', **settings)
        self.lookup = lookup
        self.name = name
        self.source = source
        self.encoding = encoding
...
class Jinja2Template(BaseTemplate):
    def __init__(self, source=None, name=None, lookup=None, encoding='utf8', **settings):
        super(Jinja2Template, self).__init__(source=None, name=None, lookup=None, encoding='utf8', **settings)
        self.source = source
        self.name = name
        self.encoding = encoding
        self.lookup = lookup
...
class SimpleTemplate(BaseTemplate):
    def __init__(self, source=None, name=None, lookup=None, encoding='utf8', **settings):
        super(SimpleTemplate, self).__init__(source=None, name=None, lookup=None, encoding='utf8', **settings)
        self.source = source
        self.encoding = encoding
        self.name = name
        self.lookup = lookup
